...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Stanley.Conroy',
      password: 'yy3J4DrKzB8oIcS',
      email: 'Alisa_Johns34@hotmail.com',
      name: 'Miss Kendra Stokes',
      shippingAddress: [
        {
          _id: false,
          pincode: 'SCSI',
      ...
      userType: 319,
      mobileNo: '(620) 992-9342',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 55,
      loginReactiveTime: '2024-08-18T13:09:31.036Z',
      id: '657f25eb2bd25e25af1adc52'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Joshuah14',
        'password':'PFdYVDigEJzUu_1',
        'email':'Darrick73@yahoo.com',
        'name':'Lynette Bruen',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Cross-platform',
          'address1':'hacking',
          'address2':'Officer',
          'landmark':'District',
          'city':'circuit',
          ...
          'state':'Compatible',
          'addressType':'Bike',
          'fullName':'methodologies',
          'mobile':839,
          'addressNo':865
        }],
        'wishlist':[{
          '_id':false,
          'productId':'Down-sized'
        }],
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(065) 428-6386',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Darrick73@yahoo.com', });
