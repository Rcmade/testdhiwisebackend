...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Salvador.Schuppe92',
      password: 'cw7Eo_A5Gh9gpvY',
      email: 'Brice17@yahoo.com',
      name: 'Cecelia Ryan',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 832,
      mobileNo: '(904) 894-5549',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 386,
      loginReactiveTime: '2024-02-21T20:42:55.222Z',
      id: '657f25eb2bd25e25af1add36'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Elvera86',
        'password':'JfGhtb_x6cVTVyj',
        'email':'Yasmine_Fahey@yahoo.com',
        'name':'Ashley Haley',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Ergonomic',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Yasmine_Fahey@yahoo.com', });
